create function find_books(user_id integer, search character varying, bestseller boolean, disc boolean, from_date date,
                           to_date date)
    returns TABLE
            (
                id            integer,
...
'
    BEGIN
        return query select b.id,
                     ...
                     group by b.id, b.discount, b.image, b.image_id, b.is_bestseller, b.popularity, b.price, b.slug,
                              b.title,
