    ...
    $(function () {
                            ...
                            validate.forEach(function (v) {
                                switch (v) {
                                    ...
                                    case'mail':
                                        ...
                                        break;
                                    case'money':
                                        if ($this.val() !== '' && !$this.val().match(/^[0-9]*[.,]?[0-9]+$/)) {
                                            message += 'Сумма должна состоять из цифр больше нуля';
                                            error = true;
                                        }
                                        break;
                                    case'pass':
            ...
            return {
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        e.preventDefault();
                        if (pageSearch && $Middle.find('.Middle-searchHeader').length > 0) {
                                ...
                                $.ajax({
                                    ...
                                    complete: function (result) {
                                        if (result.status === 200) {
                                            ...
                                            if (result.responseJSON.totalElements == 0) {
                                                window.location = '\/search\/' + $this.find('.search-input').val();
                                            }
                                            var data = '';
                                            result.responseJSON.content.forEach(function (book) {
                                                data += Card().bookTemplate(book);
                                            });
                                            var $Cards = $('.Cards_refresh');
                                            $Middle.find('.Middle-searchHeader').text('Найдено ' +
                                                result.responseJSON.totalElements + ' книг' +
                                                (result.responseJSON.totalElements % 10 < 10 && result.responseJSON.totalElements % 10 > 20 ? (result.responseJSON.totalElements % 10 === 1 ? 'a' : (result.responseJSON.totalElements % 10 > 1 && result.responseJSON.totalElements % 10 < 5 ? 'и' : '')) : ''))
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + "/books/" + book.slug + '">' + '       <img src="/img/' + book.image + '">\n' + '</a>' +
            ...
            return {
                init: function () {
                    $('[data-refreshshow]').on('click change', function (e) {
                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        ...
                                        $this.data('total', result.responseJSON.totalPages);
                                ...
                                if (e.type === 'change') {
                                    ...
                                    if (!$this.hasClass('form-input_date_uninit')) {
                                        ...
                                        $refreshoffset.each(function () {
                                            var $this = $(this);
                                            $this.closest('.btn_primary').css('display', 'flex');
                        ...
                        if ($this.data('total') == $this.data('refreshoffset') + 1) {
                            $this.closest('.btn_primary').css('display', 'none');
                        }
                    });
            ...
            return {
                init: function () {
                            ...
                            $.ajax({
                                ...
                                success: function (result) {
                                    ...
                                    $this.append('<div class="Comment">\n' +
                                        ...
                                        '                                        <div>\n' +
                                        '                                            <strong class="Comment-title">' + result.name + '</strong>\n' +
                                        '                                            <span class="Comment-date">' + result.date + '</span>\n' +
                                        '                                        </div>\n' +
                                        '                                    </header>\n' +
                                ...
                                error: function (error) {
                                    ...
                                    if (error.responseJSON) {
                                        $textarea.addClass('form-textarea_error').after('<div class="form-error">' + error.responseJSON.text + '</div>');
                                    } else {
                                        $textarea.addClass('form-textarea_error').after('<div class="form-error">' + error.responseText + '</div>');
                                    }
                                }
                            });
                        }
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/api/review/rateBookReview', data, function (result) {
                            if (result != null && result.result) {
                                ...
                                $('.form-textarea_error').hide();
                                $this.find('.form-textarea_error').show(0);
                                setTimeout(function () {
                                    $this.find('.form-textarea_error').hide();
                                }, 5000)
                            }
                        });
                    });
        ...
        var Login = function () {
            ...
            var $restoreButton = $('button[name="restorePass"]');
            ...
            return {
                init: function () {
                    $('#saveProfile').on('click', function () {
                        let $this = $(this), $row = $this.closest('.Login_registration'),
                            data = {
                                firstname: $row.find('.form-input_firstname').val(),
                                lastname: $row.find('.form-input_lastname').val(),
                                email: $row.find('.form-input_mail').val(),
                                oldEmail: $row.find('#submitChangeMail').attr('data-mail'),
                                approvedMail: $row.find('#submitChangeMail').attr('data-approved'),
                                phone: $row.find('.form-input_phone').val(),
                                oldPhone: $row.find('#submitChangePhone').attr('data-phone'),
                                approvedPhone: $row.find('#submitChangePhone').attr('data-approved'),
                                password: $row.find('.form-input_password').val(),
                                passwordRepeat: $row.find('.form-input_password_repeat').val()
                            }
                        postData('/api/profile/change', data, function (result) {
                            if (result.message) {
                                ...
                                $row.find('#submitChangeMail').attr('data-mail', data.email);
                                $row.find('#submitChangePhone').attr('data-phone', data.phone);
                            } else {
                                result.firstname ? $("#firstnameError").text(result.firstname) : $("#firstnameError").text("");
                                result.lastname ? $("#lastnameError").text(result.lastname) : $("#lastnameError").text("");
                                result.email ? $("#emailError").text(result.email) : $("#emailError").text("");
                                result.phone ? $("#phoneError").text(result.phone) : $("#phoneError").text("");
                                result.password ? $("#passwordError").text(result.password) : $("#passwordError").text("");
                                result.passwordRepeat ? $("#passwordRepeatError").text(result.passwordRepeat) : $("#passwordRepeatError").text("");
                            }
                        })
                    });
                                ...
                                complete: function (response) {
                                    if (response.status === 200) {
                                        $.ajax({
                                            ...
                                            complete: function (result) {
                                                if (result.status === 200) {
                                                    let data = result.responseJSON.user;
                                                    $("#message").text(result.responseJSON.message);
                                                    $row.find('.form-input_firstname').val(data.firstname);
                                                    $row.find('.form-input_lastname').val(data.lastname);
                                                    $row.find('.form-input_password').val('');
                                                    $row.find('.form-input_password_repeat').val('');
                                                    $row.find('.form-input_mail').val(data.mail)
                                                    $row.find('.form-input_phone').val(data.phone);
                                                    $("#firstnameError").text("");
                                                    $("#lastnameError").text("");
                                                    $("#emailError").text("");
                                                    $("#phoneError").text("");
                                                    $("#passwordError").text("");
                                                    $("#passwordRepeatError").text("");
                                                    $row.find('.Profile-btn_confirm_mail').hide();
                                                    $row.find('.Profile-btn_confirm_phone').hide();
                                                    if ($row.find('#submitChangeMail').attr('data-approved') == 1) {
                                                        $row.find('.check-mail').css('color', '#6db33f')
                                                    }
                                                    if ($row.find('#submitChangePhone').attr('data-approved') == 1) {
                                                        $row.find('.check-phone').css('color', '#6db33f')
                                                    }
                                                }
                                            }
                                        });
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/api/requestNewContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Вам поступит звонок-сброс с уникального номера. Введите последние 4 цифры этого номера</div>')
                                ...
                                $row.find('.form-error').remove();
                                $row.find('.form-input_phone').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                            }
                        })
                    });
                    $('#submitMail').on('click', function () {
                        ...
                        postData('/api/requestNewContactConfirmation', data, function (result) {
                            if (result.result) {
                                ...
                                $row.find('.form-error').remove();
                                $row.find('.form-input_mail').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                            }
                        })
                    });
                    $('#submitChangeMail').on('click', function () {
                        var $this = $(this), $row = $this.closest('.form-group_mail'),
                            data = {
                                contact: $row.find('.form-input_mail').val(),
                                contactType: 'MAIL',
                                oldContact: $this.data('mail')
                            };
                        postData('/api/requestChangeContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Вам направлен код подтверждения в письме на почту</div>')
                                $this.attr('disabled', 'disabled');
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                                $row.find('#submitChangeMail').attr('data-mail', data.contact)
                            } else {
                                $row.find('.form-error').remove();
                    ...
                    $('#submitChangePhone').on('click', function () {
                        var $this = $(this), $row = $this.closest('.form-group_phone'),
                            data = {
                                contact: $row.find('.form-input_phone').val(),
                                contactType: 'PHONE',
                                oldContact: $this.data('phone')
                            };
                        ...
                        postData('/api/requestChangeContactConfirmation', data, function (result) {
                            if (result.result) {
                                ...
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                                $row.find('#submitChangePhone').attr('data-phone', data.contact)
                            } else {
                                $row.find('.form-error').remove();
                                $row.find('.form-input[type="text"]').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                            }
                    ...
                    $Registration.find('.form-input_code').on('blur', function () {
                        var $this = $(this),
                            $row = $this.closest('.form-group_row, .form-group_mail, .form-group_phone'), data = {
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/api/approveContact', data, function (result) {
                                if (result.result && result.error == null) {
                                    $this.attr('disabled', 'disabled');
                                    $but.attr('disabled', 'disabled');
                                    $but.after('<div class="form-info">Код успешно подтвержден</div>');
                                    $row.find('.check-' + result.type.toLowerCase()).css('color', '#6db33f')
                                    $this.trigger('change');
                                } else {
                                    if (!result.result && result.error != null) {
                    ...
                    $sendButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            $this.data('send', {contact: contact, contactType: $this.data('type').toUpperCase()});
                            if (!error) {
                                postData('/api/requestContactConfirmation', $this.data('send'), function (result) {
                                    if (result.result) {
                                        $thisStep.addClass('Login-step_hide');
                                        $thisStep.addClass('Login-step_completed');
                                        $LoginStep.find('[data-send]').data('send', {
                                            contact: contact,
                                            contactType: $this.data('type').toUpperCase()
                                        });
                            ...
                            if (!error) {
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result && result.error == null) {
                                        ...
                                        window.location.href = referrer.includes('restore/') ? '/' : referrer;
                                    } else {
                                        if (!result.result) {
                                            $thisStep.addClass('Login-step_hide');
                                            ...
                                            $thisStep.find('.form-group_key').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                                        }
                                    }
                                })
                            }
                    ...
                    $restoreButton.on('click', function (e) {
                        ...
                        var $thisStep = $this.closest($LoginStep);
                        var send = $this.data('send');
                        postData('restore', send, function (result) {
        ...
        var ProductCard = function () {
            ...
            function shiftCheck($element, wave) {
                var text = '', check = $element.data('check'), $this = $(this),
                    $row = $this.closest('.ProductCard-cart');
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            Login().postData('/api/books/changeBookStatus', {
                            ...
                            Login().postData('/api/books/changeBookStatus', {
                                ...
                                if (result.result) {
                                    $.get("/api/books/size/cart", function (data) {
                                        $('#cartt').text(data);
                                    });
                                    $.get("/api/books/size/postponed", function (data) {
                                        $('#keptt').text(data);
                                    });
                                    ...
                                    if ($cart.length) {
                                        ...
                                        $cart.find('.Cart-product').each(function () {
                                            ...
                                            priceOld += $this.find('.Cart-price_old').length == 0
                                                ? parseFloat($this.find('.Cart-price').text())
                                                : parseFloat($this.find('.Cart-price_old').text());
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/api/books/rateBook', {
                                ...
                                if (result.result) {
                                    $ProductAssesment.find('.ProductCard-titleProp').text($ProductAssesment.find('.ProductCard-titleProp').attr('data-altText'))
                                    $title.addClass('Rating-title_success').text(result.text);
                                    let $ProductCardRating = $('.ProductCard-rating');
                                    $ProductCardRating.find('#Rating-title').text('(' + result.value + ')')
                                    for (let key in result.maps) {
                                        $ProductCardRating.find('.' + key).text(result.maps[key]);
                                    }
                                } else {
                    ...
                    $ProductAssesment.find('.Rating input').mouseover(function (e) {
                        var $this = $(this), check = $this.prop('checked');
                    });
            ...
            return {
                init: function () {
                    ...
                    $('input[name="mail"]').on('input', function () {
                        var $this = $(this), $row = $this.closest('.Login_registration');
                        let mail = $row.find('.form-input_mail').val();
                        let oldMail = $row.find('#submitChangeMail').attr('data-mail')
                        $("#emailError").text("")
                        if (mail !== oldMail && mail.match(/\w+@\w+\.\w+/)) {
                            $row.find('.check-mail').css('color', 'red')
                            $row.find('.Profile-btn_confirm_mail').show(0);
                        } else {
                            if ($row.find('#submitChangeMail').attr('data-approved') == 1 && mail == oldMail)
                                $row.find('.check-mail').css('color', '#6db33f')
                            else {
                                $row.find('.check-mail').css('color', 'red')
                                $("#emailError").text("Email должен быть в формате xxx@xxx.xx")
                            }
                            $row.find('.Profile-btn_confirm_mail').hide();
                        }
                    ...
                    $('input[name="phone"]').keyup(function () {
                        let $this = $(this), $row = $this.closest('.Login_registration');
                        let phone = $row.find('.form-input_phone').val();
                        let oldPhone = $row.find('#submitChangePhone').attr('data-phone')
                        $("#phoneError").text("")
                        if (phone !== oldPhone && !phone.endsWith('x')) {
                            $row.find('.check-phone').css('color', 'red')
                            $row.find('.Profile-btn_confirm_phone').show(0);
                        } else {
                            if ($row.find('#submitChangePhone').attr('data-approved') == 1 && phone == oldPhone)
                                $row.find('.check-phone').css('color', '#6db33f')
                            else {
                                $row.find('.check-phone').css('color', 'red')
                                $("#phoneError").text("Телефон должен быть в формате +7 (xxx) xxx-xx-xx")
                            }
                            $row.find('.Profile-btn_confirm_phone').hide();
                        }
                    });
                    ...
                    $('#submitChangeMail').click(function () {
        ...
        var Rating = function () {
            return {
                init: function () {
                    ...
                    //     $(this).addClass('Rating-star_view');
                    // });
                            ...
                            $this.on('afterChange', function (e, slick) {
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address, property) {
                                            getData(address, {
                                                offset: function () {
                                                    var oldOfsset = $(slick.$slider).data('loadoffset');
                                                    $(slick.$slider).data('loadoffset', ++oldOfsset);
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                sendData('/api/books', 'recommend')
                                                break;
                                            case'recent':
                                                sendData('/api/books', 'pub_date')
                                                break;
                                            case'popular':
                                                sendData('/api/books', 'popularity')
                                                break;
                                            case'viewed':
                                                sendData('/api/books', 'viewed')
                                                break;
                                        }
                                    }
                                }
        ...
        var Transactions = function () {
            var transactionTemplate = function (transaction) {
                let s = transaction.value > 0 ? '+' : '-';
                return '<tr>\n' + '                      <td>' + transaction.time + '                      </td>\n' + '                      <td><span class="Transactions_textSuccess">\n' + '                          <strong>'
                    + s + transaction.value + ' р.\n' + '                          </strong></span>\n' + '                      </td>\n' + '                      <td>' + transaction.description + ' ' + '<a href="/books/' + transaction.books.slug + '">' + transaction.books.title + '</a>                      </td>\n' + '                    </tr>';
            }
            ...
            function getData(address, data) {
                ...
                $.ajax({
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            var data = '';
                            result.responseJSON.content.forEach(function (transaction) {
                ...
                init: function () {
                    $('.Transactions-get').on('click', function (e) {
                        ...
                        getData('/api/transactions', {
                            offset: function () {
                                var oldPage = $this.data('transactionoffset');
                                $this.data('transactionoffset', ++oldPage);
                        ...
                        if ($this.data('total') == $this.data('transactionoffset') + 1) {
                            $this.closest('.Transactions-get').remove();
                        }
                    });
                }
            };
        ...
        var History = function () {
            var historyTemplate = function (history) {
            ...
            function getData(address, data) {
                ...
                $.ajax({
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            var data = '';
                            result.responseJSON.forEach(function (loginStory) {
                                data += historyTemplate(loginStory);
                            });
                            $('.Story tbody').append(data);
                            $(window).scrollTop(scroll);
                        } else {
                            alert('Ошибка ' + result.status);
                        }
            ...
            return {
                init: function () {
                    $('.History-get').on('click', function (e) {
                        var $this = $(this);
                        e.preventDefault();
                        getData('/api/loginStory', {
                            page: function () {
                                var oldPage = $this.data('page');
                                $this.data('page', ++oldPage);
                                return $this.data('page');
                            },
                            size: $this.data('size')
                        })
                        if ($this.data('total') == $this.data('page') + 1)
                            $this.closest('.History-get').remove();
                    });
                }
            };
        };
