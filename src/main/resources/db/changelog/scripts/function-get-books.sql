create function get_books(user_id integer)
    returns TABLE(id integer, description text, discount double precision, image character varying, is_bestseller smallint, popularity double precision, price integer, slug character varying, title character varying, pub_date date, code character varying, user_rating integer, rate numeric, count1 bigint, count2 bigint, count3 bigint, count4 bigint, count5 bigint)
    language plpgsql
as
'
BEGIN
    return query select b.id,
                 ...
                 group by b.id, b.description, b.discount, b.image, b.is_bestseller, b.popularity,
                          b.price, b.slug, b.title, b.pub_date, t.code, br.rating;
end
';
