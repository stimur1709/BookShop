...
(function ($) {
    ...
    $(document).ready(function () {
        $.get("/api/cartSize", function (data) {
            // $(this).find('.CartBlock-amount').text(5);
        });

        $.get("/api/keptSize", function (data) {
            console.log(data);
            $('#CartBlock-amount Kept').append(5);
            // $(this).find('.CartBlock-amount Kept').text(5);
        })
    });
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/books/changeBookStatus/' + $this.data('bookid'), {
                                ...
                                if (result) {
                                    ...
                                    $this.after('<div class="btnError">' + result + '</div>');
                                }
